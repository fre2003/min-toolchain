...
HOST_WIDEST_INT parse_escape (char **, HOST_WIDEST_INT);
HOST_WIDEST_INT parse_c_expression (char *, int);

...
#define DO_PROTO (U_CHAR *, U_CHAR *, FILE_BUF *, struct directive *)
...
static void safe_write (int, char *, int);
static void eprint_string (const char *, size_t);
static void path_include (char *);

static U_CHAR *index0 (U_CHAR *, int, size_t);

static void trigraph_pcp (FILE_BUF *);

static void newline_fix (U_CHAR *);
static void name_newline_fix (U_CHAR *);

static char *get_lintcmd (U_CHAR *, U_CHAR *, U_CHAR **, int *, int *);

static void rescan (FILE_BUF *, int);

static FILE_BUF expand_to_temp_buffer (U_CHAR *, U_CHAR *, int, int);

static int handle_directive (FILE_BUF *, FILE_BUF *);

static struct tm *timestamp (void);
static void special_symbol (HASHNODE *, FILE_BUF *);

static int is_system_include (char *);
static char *base_name (char *);
static int absolute_filename (char *);
static size_t simplify_filename (char *);

static char *read_filename_string (int, FILE *);
static struct file_name_map *read_name_map (char *);
static int open_include_file (char *, struct file_name_list *, U_CHAR *, struct include_file **);
static char *remap_include_file (char *, struct file_name_list *);
static int lookup_ino_include (struct include_file *);

void finclude (int, struct include_file *, FILE_BUF *, int, struct file_name_list *);
static void record_control_macro (struct include_file *, U_CHAR *);

static char *check_precompiled (int, struct stat *, char *, char **);
static int check_preconditions (char *);
static void pcfinclude (U_CHAR *, U_CHAR *, FILE_BUF *);
static void pcstring_used (HASHNODE *);
static void write_output (void);
static void pass_thru_directive (U_CHAR *, U_CHAR *, FILE_BUF *, struct directive *);

static MACRODEF create_definition (U_CHAR *, U_CHAR *, FILE_BUF *);

static int check_macro_name (U_CHAR *, int);
static int compare_defs (DEFINITION *, DEFINITION *);
static int comp_def_part (int, U_CHAR *, int, U_CHAR *, int, int);

static DEFINITION *collect_expansion  (U_CHAR *, U_CHAR *, int, struct arglist *);

int check_assertion (U_CHAR *, int, int, struct arglist *);
static int compare_token_lists (struct arglist *, struct arglist *);

static struct arglist *read_token_list (U_CHAR **, U_CHAR *, int *);
static void free_token_list (struct arglist *);

static ASSERTION_HASHNODE *assertion_install (U_CHAR *, int, int);
static ASSERTION_HASHNODE *assertion_lookup (U_CHAR *, int, int);
static void delete_assertion (ASSERTION_HASHNODE *);

static void do_once (void);

static HOST_WIDEST_INT eval_if_expression (U_CHAR *, int);
static void conditional_skip (FILE_BUF *, int, enum node_type, U_CHAR *, FILE_BUF *);
static void skip_if_group (FILE_BUF *, int, FILE_BUF *);
static void validate_else (U_CHAR *, U_CHAR *);

static U_CHAR *skip_to_end_of_comment (FILE_BUF *, int *, int);
static U_CHAR *skip_quoted_string (U_CHAR *, U_CHAR *, int, int *, int *, int *);
static char *quote_string (char *, char *, size_t);
static U_CHAR *skip_paren_group (FILE_BUF *);
...
struct argdata;
static int macarg (struct argdata *, int);

static U_CHAR *macarg1 (U_CHAR *, U_CHAR *, struct hashnode *, int *, int *, int *, int);
...
static void vnotice (const char *, va_list);
void error (const char *, ...);
void verror (const char *, va_list);
static void error_from_errno (char *);
void warning (const char *, ...);
static void vwarning (const char *, va_list);
static void error_with_line (int, const char *, ...);
static void verror_with_line (int, const char *, va_list);
static void vwarning_with_line (int, const char *, va_list);
static void warning_with_line (int, const char *, ...);
void pedwarn (const char *, ...);
void pedwarn_with_line (int, const char *, ...);
static void pedwarn_with_file_and_line (const char *, size_t, int, const char *, ...);
static void pedwarn_strange_white_space (int);
...
static HASHNODE *install (U_CHAR *, int, enum node_type, char *, int);
HASHNODE *lookup (U_CHAR *, int, int);
static void delete_macro (HASHNODE *);
static int hashf (U_CHAR *, int, int);

static void dump_single_macro (HASHNODE *, FILE *);
static void dump_all_macros (void);
static void dump_defn_1 (U_CHAR *, int, int, FILE *);
static void dump_arg_n (DEFINITION *, int, FILE *);

static void initialize_char_syntax (void);
static void initialize_builtins (FILE_BUF *, FILE_BUF *);

static void make_definition (char *);
static void make_undef (char *, FILE_BUF *);

static void make_assertion (const char *, const char *);

static struct file_name_list *new_include_prefix (struct file_name_list *, const char *, const char *, const char *);
static void append_include_chain (struct file_name_list *, struct file_name_list *);

static int quote_string_for_make (char *, const char *);
void deps_output (const char *, int);

void fatal (const char *, ...);
void fancy_abort (void);
static void perror_with_name (char *);
static void pfatal_with_name (char *);
static void pipe_closed (int);
...
static void
error_with_line (int line, const char * msgid, ...)
{
#ifndef ANSI_PROTOTYPES
  int line;
  const char * msgid;
...
static void
warning_with_line (int line, const char * msgid, ...)
{
#ifndef ANSI_PROTOTYPES
  int line;
  const char * msgid;
...
void
pedwarn_with_line (int line, const char * msgid, ...)
{
#ifndef ANSI_PROTOTYPES
  int line;
  const char * msgid;
...
static void
pedwarn_with_file_and_line (const char *file, size_t file_len, int line,
				    const char * msgid, ...)
{
#ifndef ANSI_PROTOTYPES
  const char *file;
