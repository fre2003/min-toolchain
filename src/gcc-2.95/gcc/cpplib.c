...
/* CPP_IS_MACRO_BUFFER is true if the buffer contains macro expansion. (Note that it is false while we're expanding macro *arguments*.) */
...
static HOST_WIDEST_INT eval_if_expression(cpp_reader*);

static void conditional_skip(cpp_reader*, int, enum node_type, U_CHAR*);
static void skip_if_group(cpp_reader*);

static void parse_name(cpp_reader*, int);
static void parse_string(cpp_reader*, int);
static int parse_assertion(cpp_reader*);

/* External declarations.  */

extern HOST_WIDEST_INT cpp_parse_expr (cpp_reader *);
...
struct directive
{
  ...
  int(*func)(cpp_reader *, struct directive*); /* Function to handle directive */
...
void
cpp_error (cpp_reader * pfile, const char *msgid, ...)
{
...
void
cpp_warning (cpp_reader * pfile, const char *msgid, ...)
{
#ifndef ANSI_PROTOTYPES
  cpp_reader *pfile;
  const char *msgid;
...
void
cpp_pedwarn (cpp_reader * pfile, const char *msgid, ...)
{
#ifndef ANSI_PROTOTYPES
  cpp_reader *pfile;
  const char *msgid;
...
void
cpp_error_with_line (cpp_reader * pfile, int line, int column, const char *msgid, ...)
{
#ifndef ANSI_PROTOTYPES
  cpp_reader *pfile;
  int line;
...
void
cpp_warning_with_line (cpp_reader * pfile, int line, int column, const char *msgid, ...)
{
#ifndef ANSI_PROTOTYPES
  cpp_reader *pfile;
  int line;
...
void
cpp_pedwarn_with_line (cpp_reader * pfile, int line, int column, const char *msgid, ...)
{
#ifndef ANSI_PROTOTYPES
  cpp_reader *pfile;
  int line;
...
void
cpp_pedwarn_with_file_and_line(cpp_reader * pfile, char* file, int line, const char* msgid, ...)
{
#ifndef ANSI_PROTOTYPES
  cpp_reader *pfile;
  char *file;
