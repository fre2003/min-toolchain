...
extern void parse_set_mark	(cpp_reader *);
extern void parse_clear_mark	(cpp_reader *);
extern void parse_goto_mark	(cpp_reader *);
...
extern void cpp_assert(cpp_reader*, unsigned char*);
extern void cpp_undef(cpp_reader*, unsigned char*);
extern void cpp_unassert(cpp_reader*, unsigned char*);
...
extern void cpp_warning_with_line(cpp_reader*, int, int, const char*, ...);
...
extern HOST_WIDEST_INT cpp_parse_escape(cpp_reader*, char**, HOST_WIDEST_INT);
extern cpp_buffer* cpp_push_buffer(cpp_reader *, unsigned char*, long);
extern cpp_buffer* cpp_pop_buffer(cpp_reader*);

extern cpp_hashnode* cpp_lookup(cpp_reader *, const unsigned char*, int, int);
...
extern void quote_string(cpp_reader*, const char*);
extern void cpp_expand_to_buffer(cpp_reader*, U_CHAR *, int);
extern void cpp_scan_buffer(cpp_reader*);
extern int check_macro_name(cpp_reader*, U_CHAR *, int);

/* Last arg to output_line_command.  */
enum file_change_code { same_file, enter_file, leave_file };
extern void output_line_command(cpp_reader*, enum file_change_code);
...
extern void cpp_notice(const char* msgid, ...);

/* In cppfiles.c */
extern void simplify_pathname(char*);
extern void merge_include_chains(struct cpp_options*);
extern int find_include_file(cpp_reader*, char*, struct file_name_list*, struct include_hash**, int*);
extern int finclude(cpp_reader*, int, struct include_hash*);
